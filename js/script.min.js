...
"use strict";require("babel-polyfill");var fetch=require("isomorphic-fetch"),youTubePlayer=require("youtube-player"),youTubeKey="AIzaSyDsRp772hAESsvu5cKVYofvXNbepWkLk7k",player=youTubePlayer("video-player"),list=document.querySelector(".video-thumbnails"),listInner=document.createElement("ul");fetch("https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=PLB2FB2679A8BA210D&key="+youTubeKey).then(function(e){return e.json()}).then(function(e){return e.items.map(function(e){return e.snippet})}).then(function(e){player.cueVideoById(e[0].resourceId.videoId),e.forEach(function(e){var t=document.createElement("li"),n=document.createElement("img"),d=document.createElement("a");n.setAttribute("src",e.thumbnails.default.url),n.setAttribute("alt",e.title),d.setAttribute("href","https://www.youtube.com/watch?v="+e.resourceId.videoId),d.setAttribute("data-ytid",e.resourceId.videoId),d.addEventListener("click",function(e){e.preventDefault(),player.loadVideoById(d.getAttribute("data-ytid"))}),d.appendChild(n),t.appendChild(d),listInner.appendChild(t)}),list.appendChild(listInner)});var dayOfWeek=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],table=document.createElement("table");fetch("https://cdn.contentful.com/spaces/xzsiyum2s4j9/entries?access_token=d06c9d6884601c65215539301710240a84655d7d84d870ef5af84505002513f0&content_type=gig&order=fields.dateAndTime").then(function(e){return e.json()}).then(function(e){return e.items.map(function(e){return e.fields})}).then(function(e){e.forEach(function(e){var t=document.createElement("tr"),n=document.createElement("td"),d=document.createTextNode(e.title);if(e.link){var a=document.createElement("a");a.setAttribute("href",e.link),a.appendChild(d),n.appendChild(a)}else n.appendChild(d);t.appendChild(n);var r=new Date(e.dateAndTime),i=document.createTextNode(dayOfWeek[r.getUTCDay()]+" "+r.getUTCDate()+" "+months[r.getUTCMonth()]+" "+r.getUTCFullYear()),u=document.createElement("td");u.appendChild(i),t.appendChild(u);var c=document.createElement("td");if(e.address){var o=document.createElement("a");o.setAttribute("href","https://maps.google.com/?q"+e.address);var l=document.createTextNode(e.address);o.appendChild(l),c.appendChild(o)}t.appendChild(c);var p=document.createElement("td"),s=document.createTextNode(e.description);p.appendChild(s),t.appendChild(p),table.appendChild(t)});document.querySelector(".gigs").appendChild(table)});

},{"babel-polyfill":2,"isomorphic-fetch":329,"youtube-player":341}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":3,"core-js/shim":326,"regenerator-runtime/runtime":333}],3:[function(require,module,exports){
...
},{"./debug":328,"_process":332}],328:[function(require,module,exports){
...
},{"ms":331}],329:[function(require,module,exports){
...
},{"whatwg-fetch":335}],330:[function(require,module,exports){
...
},{"./constants/PlayerStates":338}],337:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./FunctionStateMap":336,"./eventNames":339,"./functionNames":340,"debug":327}],338:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./YouTubePlayer":337,"./loadYouTubeIframeApi":342,"sister":334}],342:[function(require,module,exports){
'use strict';
